...
/* ESSENTIAL CODE */
var VersionTitle = "STS - Simple Timer System";
...
function OnloadTasks(){
	...
	switch (PageName){
		...
		case "STI_Timer.html":
			...
			pageProperty_PageTitle = "Contest Timer";
			pageProperty_enableGreetings = 0;
...
function generate_Launcher_NavigationList(){
	let navigationListItems = ["Home", "Shortcut Editor", "STI TNT Timer", "Video Timer"]; //Launcher navigation text
	let navigationListItems_Link = ["DL_Main.html", "DL_ShortcutEditor_Dev.html", "STI_Timer.html", "Assets/AlternativeTimer.mp4"]; //Launcher navigation links
...
function SE_Swapper_SelectItem_Category_InBetween(id){
	...
	if (SE_Swapper_SwapStage == 2){
		SE_Array_Category_Index.splice(SE_Swapper_Index_1, 1);
		SE_Array_Category_Index.splice(SE_Swapper_InBetween_NewIndex, 0, SE_Swapper_Data_1);
		console.log(SE_Array_Category_Index);
		// localStorage.setItem("DL_CategoryIndex", JSON.stringify(SE_Array_Category_Index));
	}
	refresh_ShortcutEditor();
